...
const Hero = ({ movie }: HeroProps) => {
  ...
  if (!movie) return (
    <div className="h-[70vh] md:h-[90vh] bg-[#050505] flex items-center justify-center">
  ...
  return (
    <div className="relative h-[75vh] md:h-[92vh] w-full text-white overflow-hidden bg-[#050505]">
      ...
      <div className="absolute inset-0 z-20 flex pt-32 pb-20 px-6 sm:px-10 items-end justify-center md:justify-start md:px-24">
        <div className="w-full md:max-w-3xl text-center md:text-right">
          <AnimatePresence mode="wait">
            ...
            >
               ...
               <h1 className="text-4xl sm:text-6xl md:text-8xl font-black mb-6 tracking-tighter leading-tight italic">
                  {movie.title}
               </h1>
               
               <p className="text-gray-400 text-sm sm:text-base md:text-lg mb-8 md:mb-10 max-w-xl mx-auto md:mr-0 leading-relaxed opacity-90 line-clamp-3 sm:line-clamp-4">
